...
#   }
# }
if(!"SpatialDecon" %in% installed.packages()[,"Package"]) {
...
save.image(file = "/mnt/disks/datadisk1/gsbucket/geomx/ngs/code/DSP_hydra_session_pregenefilter_preqcnorm.RData")
...
save.image(file = "/mnt/disks/datadisk1/gsbucket/geomx/ngs/code/DSP_hydra_session_pregenefilter.RData")
...
# Payman -- Jason's fix for messed up UMAP/tSNE plots by reordering columns of dfs[[1]] & dfs[[2]] to match rows of dfs[[3]]
...
## ##############################################################################
# Payman: save current environment to file
save.image(file = "/mnt/disks/datadisk1/gsbucket/geomx/ngs/code/DSP_hydra_session.RData")

## ## load(file = "/mnt/disks/datadisk1/gsbucket/geomx/ngs/code/DSP_hydra_session.RData")
